...
let time = 0;
let sizeId = ['1635916714748932' , '1635910918152321' , '1635919428929111' , '1635919428937303' , '1635919428908631' , '1635916714724356','1635916714736644', '1635910918140033']
...
export class IndexService {
	...
	async buy(data: IndexDataDto){
		...
		while(true){
			...
			res.forEach(data=>{
				console.log(data.data.msg, data.config.data);
			})
