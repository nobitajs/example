...
@Module({
  ...
  imports: [ConfigModule, KafkaModule, CacheModule, MongodbModule, RedisModule, ScheduleModule, HttpModule, HelperModule, RouterModule],
  exports: [ConfigModule, KafkaModule, CacheModule, MongodbModule, RedisModule, ScheduleModule, HttpModule, HelperModule]
})
