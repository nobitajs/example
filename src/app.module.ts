...
@Module({
  ...
  imports: [ConfigModule, KafkaModule, CacheModule, RedisModule, ScheduleModule, HttpModule, HelperModule, RouterModule],
  exports: [ConfigModule, KafkaModule, CacheModule, RedisModule, ScheduleModule, HttpModule, HelperModule]
})
