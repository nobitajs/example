...
@Module({
  ...
  imports: [ConfigModule, MongodbModule, RedisModule, KafkaModule, CacheModule, ScheduleModule, HttpModule, HelperModule, RouterModule],
  exports: [ConfigModule, MongodbModule, RedisModule, KafkaModule, CacheModule, ScheduleModule, HttpModule, HelperModule]
})
