...
@Module({
  ...
  imports: [ConfigModule, KafkaModule, CacheModule, ScheduleModule, HttpModule, HelperModule, RouterModule],
  exports: [ConfigModule, KafkaModule, CacheModule, ScheduleModule, HttpModule, HelperModule]
})
